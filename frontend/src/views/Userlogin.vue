        ...
        <div class="w-full h-full flex justify-center items-center ">
            <div class="px-[5%] py-[5%] bg-slate-950  rounded-3xl">
                <div class="w-full p-5">
                    <h1 class="text-white text-center font-bold text-2xl border-b border-white mb-5 pb-5">Login</h1>
                ...
                />
                <p class="text-white mb-2 mt-10 pl-3 font-bold">Password</p>
                <input
                v-model="login.password"
                  class="text-slate-500 w-full  rounded-full px-5 text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-blue-500"
                  type="password"
